"""Seed HITU Supabase database with demo data."""
...
def seed_supabase_database() -> None:
    # Supabase connection
    password = "Kali1010$$#$"
    ...
    try:
        ...
        logger.info("\n=== Demo Credentials ===")
        logger.info("Admin: admin@hitu.edu / Admin123!")
        logger.info("Doctor: doctor@hitu.edu / Doctor123!")
        logger.info("Assistant: assistant@hitu.edu / Assistant123!")
        logger.info("Student: student@hitu.edu / Student123!")
